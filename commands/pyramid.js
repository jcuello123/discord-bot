module.exports = {
  ...
  execute(message, args) {
    if (args[0].toString() == "usage")
      return message.channel.send("!pyramid [emoji] [size]");
    if (args[0].toString() == "random") randomEmojiPyramid(message, args);
    else emojiPyramid(message, args);
  },
};
...
randomEmojiPyramid = (message, args) => {
  const length = parseInt(args[1]);
